...
const cardData = [
  {
    ...
    description:
      'The "Smoke Detector for Smokers and Vapers" integrates computer vision, MQ-135 gas sensors, and temperature sensors to accurately detect smoking and vaping, providing real-time alerts to enforce no-smoking policies.',
  ...
  return (
    <Container maxWidth="lg">
      ...
      >
        ...
        <Card
          sx={{
            boxShadow: 3, // Adds elevation to the image
            maxWidth: "100%", // Ensure the card does not exceed container width
            margin: "0 auto", // Centers the card
            overflow: "hidden", // Hides any overflow
            display: "flex", // Ensures the card media fits
